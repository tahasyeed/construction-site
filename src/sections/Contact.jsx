    ...
    <div id="contact" className="bg-white w-full">
      <div className="lg:w-[80%] w-[90%] m-auto py-[60px] flex lg:flex-row flex-col justify-between items-start gap-[50px]">
        ...
        >
          ...
          {/* Contact Info */}
          <div className="mt-[60px] flex flex-col gap-6 text-gray-700 text-lg">
            {/* Address & Phone in one row */}
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-3 min-w-[250px] flex-1">
                <FaMapMarkerAlt className="text-yellow-500 text-2xl" />
                <p> Umer Colony, Namlebal, Pampore, Jammu & Kashmir, 192121, J&K</p>
              </div>
          ...
          className="text-black hover:text-yellow-800 transition-colors"
        >
         <p> Naveedwaniconstructions@gmail.com</p>
        </a>
            </div>
          </div>
        </motion.div>
